...
?>
<form action="<?php echo Route::_('index.php?option=com_mails&view=templates'); ?>" method="post" name="adminForm"
      id="adminForm">
    <div class="row">
        <div class="col-md-12">
            <div id="j-main-container" class="j-main-container">
				...
				<?php else : ?>
                                ...
                                <td>
									<?php foreach ($this->languages as $language) : ?>
                                        ...
                                        <a href="<?php echo JRoute::_('index.php?option=com_mails&task=template.edit&template_id=' . $item->template_id . '&language=' . $language->lang_code); ?>"
											...
											<?php else : ?>
                                                <span
                                                        class="badge badge-secondary"><?php echo strtoupper($language->sef); ?></span>
											<?php endif; ?>
                                        </a>
									<?php endforeach; ?>
                                </td>
					...
					<?php // Load the send Mail Form ?>
					<?php echo HTMLHelper::_(
						'bootstrap.renderModal',
						'collapseModal',
						array(
							'title'  => Text::_('COM_MAILS_SEND_TEST_MAIL'),
							'footer' => $this->loadTemplate('mails_footer'),
						),
						$this->loadTemplate('mails_body')
					); ?>
					<?php echo HTMLHelper::_(
						'bootstrap.renderModal',
						'stageModal',
